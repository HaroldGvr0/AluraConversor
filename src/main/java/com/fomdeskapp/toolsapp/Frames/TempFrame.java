...
public class TempFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona", "Celsius a Fahrenheit", "Fahrenheit a Celsius" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        args[1]= (String) jTextField1.getText();
        System.out.println(args[0]);
        System.out.println(args[1]);
        TempResultFrame newframe = new TempResultFrame(args);
